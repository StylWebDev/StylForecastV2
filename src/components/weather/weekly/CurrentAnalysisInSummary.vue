...
<template>
  <StracturesFlex :row="true" :wrap="false" items="center" justify="center" class="content-center items-center fadeIn cursor-default">
    <div><Icon class="inline max-sm:hidden min-[1921px]:hidden" width="190" :icon="icons[ weather.currentConditions.icon]"/><Icon class="hidden max-sm:inline" width="140" :icon="icons[ weather.currentConditions.icon]"/> <Icon class="inline max-[1920px]:hidden" width="250" :icon="icons[ weather.currentConditions.icon]"/></div>
    <div>
